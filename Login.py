...
def ingresar():
    ...
    if username=='admin' and password=='1234':
        ...
        Label(screen,text='Bienvenido a Fravega', bg='#fff', font=('Calibri(Body)',50,'bold')).pack(expand=True)

        screen.mainloop()

    elif username!='admin' and password!='1234':
        messagebox.showerror("Erorr","Contraseña y Usuario incorrecto")
    
    elif password!='1234':
        messagebox.showerror("Erorr","Contraseña incorrecta")

    elif username!='admin':
        messagebox.showerror("Erorr","Usuario incorrecto")
...
ingresar = Button(frame,width=6,text='Ingresar',border=0,bg='white',cursor='hand2',fg='#57a1f8')
ingresar.place(x=215,y=270) 
